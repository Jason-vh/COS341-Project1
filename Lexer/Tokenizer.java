...
//							System.err.println(errUnexpectedStr(line.substring(lineCursor, matcher.start()), lineNum, lineCursor));
						...
						token.setLocation(lineNum, matcher.start());
		...
		if (!mTokenizeGood) {
			System.out.println("Detecting one or more lexical errors, terminating..");
			System.exit(1);
		}
	}

	public void saveTokensToFile(String filename) {
		int counter = 0;
		try {
	...
	public ArrayList<Token> getTokens() {
		return new ArrayList<>(mTokenVec);
	}
